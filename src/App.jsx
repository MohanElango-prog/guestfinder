...
const guestsData = [
  { name: "Mr. Mohamed Nazarulla", table: 1 },
  { name: "Mrs. Mackiya Nazarulla", table: 1 },
  { name: "Mrs. Nahla Nazarulla", table: 1 },
  { name: "Mr Ashad Lahir", table: 1 },
  { name: "Mrs. S. Farwin", table: 1 },
  { name: "Mr Imaan Ashad", table: 1 },
  { name: "Miss Manha Ashad", table: 1 },
  { name: "Mr. Aflal Hanees", table: 1 },
  { name: "Mr. Hana Hiraz", table: 1 },

  { name: "Mr. Muaaz Zarook", table: 2 },
  { name: "Mr. Rayees Rafee", table: 2 },
  { name: "Mr. Sameer Iqbal", table: 2 },
  { name: "Mr. Ferrin Razeen", table: 2 },
  { name: "Mr. Muzammil Lateef", table: 2 },
  { name: "Mr. Hasham Muzammil (kid)", table: 2 },
  { name: "Mr. Hakeem Harees", table: 2 },
  { name: "Mrs. Kiara Faiz (2)", table: 2 },
  { name: "Mrs. Nuzrath Shazeen", table: 2 },

  { name: "Mrs. Shumrath Muaaz", table: 3 },
  { name: "Mrs. Ifrah Illiyas", table: 3 },
  { name: "Mrs. Fazla Harees", table: 3 },
  { name: "Mrs. Kajlani Mutaliph", table: 3 },
  { name: "Mr. Aqsa Muzammil", table: 3 },
  { name: "Miss. Hala Muzammil (kid)", table: 3 },
  { name: "Mrs. Jazra Jazoor", table: 3 },
  { name: "Mrs. Aysha Afzal", table: 3 },
  { name: "Mr. Raidh Ramzee", table: 3 },

  { name: "Mrs. Shameera Salahudeen", table: 4 },
  { name: "Miss. Zulaikha Mahmud", table: 4 },
  { name: "Miss. Aaliya Mahmud", table: 4 },
  { name: "Mrs. Rukkaiya Jameel", table: 4 },
  { name: "Miss. Mariam Mahmud", table: 4 },
  { name: "Mr. Arwa Irfan (K)", table: 4 },
  { name: "Mrs. Shahla Aflal", table: 4 },
  { name: "Mr. Huzair Aflal", table: 4 },
  { name: "Mr. Iyzan Faiz (4)", table: 4 },
  { name: "Mr. Aarthif Nawaz", table: 4 },

  { name: "Mr. Abdullah Mahmud", table: 5 },
  { name: "Mr. Irfan Farook", table: 5 },
  { name: "Mr. Ammar Irfan (K)", table: 5 },
  { name: "Mr. Shazeen Farook", table: 5 },
  { name: "Mr. Abdur Rahman", table: 5 },
  { name: "Mr. Azard Marzook", table: 5 },
  { name: "Mr. Faqi Faiz", table: 5 },
  { name: "Mr. Rifky Makeen", table: 5 },

  { name: "Mr. Luqman Hassan", table: 6 },
  { name: "Mr. Abdul Kareem", table: 6 },
  { name: "Mr. Harman Singh", table: 6 },
  { name: "Mr. Farhan Naushad", table: 6 },
  { name: "Mr. Dawood Shazeen", table: 6 },
  { name: "Mr. Farhan Fairoos", table: 6 },
  { name: "Mr. Arshad Ajaad", table: 6 },
  { name: "Mr. Asif Akbar", table: 6 },
  { name: "Mr. Rayyan Naizar", table: 6 },
  { name: "Mr. Yusuf Naizar", table: 6 },

  { name: "Mr. Fazeel Fulail", table: 7 },
  { name: "Mr. Anfas Fowz", table: 7 },
  { name: "Mr. Faslan Fairoos", table: 7 },
  { name: "Mr. Farazath", table: 7 },
  { name: "Mr. Rihaj Ahamed", table: 7 },
  { name: "Mr. Sajad Sahuban", table: 7 },
  { name: "Mr. Ashaz akmal", table: 7 },
  { name: "Mr. Aahil akmal", table: 7 },
  { name: "Miss. Saima Rahimi", table: 7 },
  { name: "Miss. Haseeba Azizi", table: 7 },

  { name: "Mrs. Fasniya Aslam", table: 8 },
  { name: "Miss. Misha Afzal", table: 8 },
  { name: "Mrs. Fasla Murad", table: 8 },
  { name: "Mrs. Aysha Ashroff", table: 8 },
  { name: "Mrs. Ilma Ansareen", table: 8 },
  { name: "Miss. Hanaa Murshid (K)", table: 8 },
  { name: "Mrs.Fiyassha suhail", table: 8 },
  { name: "Mrs. Farhan Hamza", table: 8 },
  { name: "Mrs.Najma Arshad", table: 8 },
  { name: "Mrs. Ashika Faizer", table: 8 },

  { name: "Mrs. Zainab Cader", table: 9 },
  { name: "Mrs. Zainab Rihmy", table: 9 },
  { name: "Mrs. Farwin Faslan", table: 9 },
  { name: "Mrs. Farazath", table: 9 },
  { name: "Miss. Hafsa Bishrul", table: 9 },
  { name: "Mrs. Akeela Sajad", table: 9 },
  { name: "Mrs. Fathima Rinaz", table: 9 },
  { name: "Mrs. Naleema Kaleer", table: 9 },
  { name: "Mr. Imdad Ilham", table: 9 },

  { name: "Mr. Murshid lahir", table: 10 },
  { name: "Mr. Hamza Murshid (K)", table: 10 },
  { name: "Mr. Anver Ansareen", table: 10 },
  { name: "Mr. Farhan Hamza", table: 10 },
  { name: "Mr. Aslam Siddeek", table: 10 },
  { name: "Mr Anzar Naik", table: 10 },
  { name: "Mr. Murad Hussain", table: 10 },
  { name: "Mr Inzam", table: 10 },
  { name: "Mr. Shabhaz Ilham", table: 10 },

  { name: "Mr. Arshad Jaleel", table: 11 },
  { name: "Mr. Rahmathullah Noor", table: 11 },
  { name: "Mr. Naizar Nadeer", table: 11 },
  { name: "Mr. Ishrath Sathar", table: 11 },
  { name: "Mr. Riyaz Mohamed", table: 11 },
  { name: "Mr. Aaseem Hussein", table: 11 },
  { name: "Mr. Mohamed Ilham", table: 11 },
  { name: "Mr Nurath Yamani", table: 11 },
  { name: "Mr. Mohammed akmal", table: 11 },
  { name: "Sheikh. Jalal Chami", table: 11 },

  { name: "Mr. Kaleer Lebbe", table: 12 },
  { name: "Mr. Nisfer Nilar", table: 12 },
  { name: "Mr. Angelo Grasso", table: 12 },
  { name: "Mr. Toby", table: 12 },
  { name: "Mr. Aravindan RV", table: 12 },
  { name: "Mr Mohamed Aleemroos", table: 12 },
  { name: "Mr. Mohamed Thahir", table: 12 },
  { name: "Mr. Nizamudeen kabeer", table: 12 },
  { name: "Mr. Masood Munwer", table: 12 },
  { name: "Mr. Rayhan Masood", table: 12 },

  { name: "Mr. Muneerullah Syed", table: 14 },
  { name: "Mr. Mohammed Dawood", table: 14 },
  { name: "Mr. Abbas Ali", table: 14 },
  { name: "Mr. Riyaz Mohamed", table: 14 },
  { name: "Mr. Musthafa Wahab", table: 14 },
  { name: "Mr. Shahul Hameed", table: 14 },
  { name: "Mr. Adam Shahul", table: 14 },
  { name: "Mrs. Dilogi Baskaran", table: 14 },
  { name: "Miss. Kaviya Siththivinayagar", table: 14 },
  { name: "Mrs Fathima Naik", table: 14 },

  { name: "Mrs. Rehana Shahul", table: 15 },
  { name: "Miss. Hafsa Nizamudeen", table: 15 },
  { name: "Mrs. Rose tharick", table: 15 },
  { name: "Mrs. Sabahath Safi", table: 15 },
  { name: "Mrs.Husnara Muneerullah", table: 15 },
  { name: "Mrs. Dilsath Abbas", table: 15 },
  { name: "Mrs. Fathima Dawood", table: 15 },
  { name: "Mrs. Shahna Ilham", table: 15 },
  { name: "Mrs Mafaza Jamaldeen", table: 15 },

  { name: "Mrs. Zazna Ishrath", table: 16 },
  { name: "Mrs. Rifana Buhary", table: 16 },
  { name: "Mrs. Nusra Siddeek", table: 16 },
  { name: "Mr. Ayaan Aaseem", table: 16 },
  { name: "Mrs. Nusra Naizar", table: 16 },
  { name: "Mrs. Elizabeth Abbey", table: 16 },
  { name: "Mrs. Vikki Grasso", table: 16 },
  { name: "Miss. Aafa Akmal", table: 16 },
  { name: "Mrs. Salma Thahir", table: 16 },

  { name: "Miss. Zahra Naizar", table: 17 },
  { name: "Miss. Sarah Naizar", table: 17 },
  { name: "Miss. Afrah Muneerullah", table: 17 },
  { name: "Miss. Shabana Mohamed", table: 17 },
  { name: "Miss. Sana Shahul", table: 17 },
  { name: "Miss. Hansa Shahul", table: 17 },
  { name: "Mrs. Sithy Thahir", table: 17 },

  { name: "Photographer", table: 18 },
  { name: "Videographer", table: 18 },
  { name: "Content creator", table: 18 },
  { name: "Mrs Rubina Mustafa", table: 18 },
];
